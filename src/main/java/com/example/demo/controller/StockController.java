...
/*
 * This controller is used check and display stock and it will redirect to AddStock.java file to order add stock.
 */
...
public class StockController {
	...
	{ //this url is used to check item.
		String url="http://localhost:8181/iteminfo/check";
	    ...
	    if(status.equals("Yes")) {
	    	...
	    	url="http://localhost:8181/iteminfo/display";
...
public ModelAndView addStock( String stock,HttpSession session)
{
	...
	String url="http://localhost:8181/iteminfo/addstock/"+itemid;
